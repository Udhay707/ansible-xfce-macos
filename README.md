...
* Open terminal and paste below command
	```
	ansible-pull -d ~/Documents/modify-desktop-ansible -U https://github.com/Udhay707/ansible-xfce-macos.git ~/Documents/modify-desktop-ansible/playbook/setup.yml -K
	```
